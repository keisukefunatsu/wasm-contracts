...
import ABI from '../../artifacts/nft.json';
import QueryMethods from '../query/nft';
import BuildExtrinsicMethods from '../build-extrinsic/nft';
import TxSignAndSendMethods from '../tx-sign-and-send/nft';
import MixedMethods from '../mixed-methods/nft';
import EventsClass from '../events/nft';
